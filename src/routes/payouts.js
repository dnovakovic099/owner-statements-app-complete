...
<div class="receipt">
  <div class="receipt-header">
    ...
    <div style="text-align:right">
      ...
      <div class="id">${paidAt.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</div>
    </div>
  </div>
  <div class="receipt-body">
    <div class="badge"><span class="dot"></span> ${statement.payoutStatus === 'collected' ? 'Collected' : 'Payment Sent'}</div>
    ...
    <div class="section">
      ...
      <div class="row"><span class="label">Revenue</span><span class="value">$${(parseFloat(statement.totalRevenue) || 0).toFixed(2)}</span></div>
      <div class="row"><span class="label">PM Commission</span><span class="value">-$${(parseFloat(statement.pmCommission) || 0).toFixed(2)}</span></div>
      <div class="row"><span class="label">Expenses</span><span class="value">-$${(parseFloat(statement.totalExpenses) || 0).toFixed(2)}</span></div>
